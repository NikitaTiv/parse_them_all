...
class ImageSerializerTestCase(GenerateImageMixin, CleanStorageMixin, TestCase):
    ...
    def test__image_serializer__create_from_data(self):
        ...
        self.assertIsNotNone(new_instanse.id)
        ...
        self.assertEqual(new_instanse.update_date, datetime(2025, 1, 1, 0, 0, tzinfo=timezone.utc))
        self.assertEqual(new_instanse.content, '')
        self.assertEqual(new_instanse.is_handled, False)
